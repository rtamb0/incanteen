...
import 'package:incanteen/constants/repository_constants/api_constants/routes/api_route_constants.dart';
import 'package:incanteen/exceptions/api/api_exceptions.dart';
import 'package:incanteen/exceptions/auth/auth_exception.dart';
import 'package:incanteen/helper/api/api_route_helper.dart';
import 'package:incanteen/helper/auth/jwt_token_helper.dart';
      ...
      if (!await jwtTokenHelper.isValidAccessToken()) {
        ...
        Response<dynamic> response = await dio
            .post(
              ...
              data: {"refresh": await jwtTokenHelper.getRefreshToken()},
            )
            .onError((DioException error, stackTrace) => handleError(error));
